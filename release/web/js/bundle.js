(() => {
  ...
  UIBase = __decorateClass([
    regClass("FyMxt0y_SV2Wt3Dlg6-l3Q")
  ], UIBase);
  ...
  GameEntry = __decorateClass([
    regClass2("XU9ZZaFmSuuHFbquMwJDmg")
  ], GameEntry);
  ...
  CameraItem = __decorateClass([
    regClass3("XDHdkIgZSQWzO-09XGR8yA")
  ], CameraItem);
  ...
  LocalizationText = __decorateClass([
    regClass4("WmLnJzGtSb-1P5b7_ysKOQ")
  ], LocalizationText);
  ...
  Scene3d = __decorateClass([
    regClass5("XSIA5B-gTUerPfSWGYCirg")
  ], Scene3d);
  ...
  __decorateClass([
    property6({ type: CameraItem })
  ], GameScene.prototype, "cameraItem", 2);
  __decorateClass([
    property6({ type: Sprite3D })
  ], GameScene.prototype, "groundStage", 2);
  __decorateClass([
    property6({ type: DirectionLight })
  ...
  GameScene = __decorateClass([
    regClass6("BwbRrrC2R6WThypjYLKJPg")
  ], GameScene);
  ...
  MainScene = __decorateClass([
    regClass7("ccjHJxc2RLGYTwJDmHLfYw")
  ], MainScene);
  ...
  PlayerController = __decorateClass([
    regClass8("8-qRHn2eTne4V9maczgoWg")
  ], PlayerController);
  ...
  var VFXMgr = class {
    ...
    createVFX(vfxEnum, aliveTime = 500, pos, stage) {
      let vfx;
      vfx = Pool4.getItem(this.$sign + vfxEnum);
      if (!vfx) {
      ...
      if (vfx) {
        ...
        Timer.get(aliveTime, this, () => {
          vfx.active = false;
          vfx.removeSelf();
          Pool4.recover(this.$sign + vfxEnum, vfx);
        }).start();
      }
    }
  };
  ...
  var BulletItem = class extends BaseItem {
    ...
    update(time) {
      if (MainGame.instance.gameStep == 1005 /* GameStart */) {
        if (!this.isOverDis) {
          this.transform.translate(new Vector36(0, 0, this.speed));
          let len = Vector36.distance(this.startPos, this.position);
  ...
  BulletItem = __decorateClass([
    regClass10("wIYJ7eviQGKOfwd5Q5Egvg")
  ], BulletItem);
  ...
  GroundItem = __decorateClass([
    regClass11("4hALosoJT8KDEpBkXDgd3A")
  ], GroundItem);
  ...
  WeaponItem = __decorateClass([
    regClass12("MDwbcJTfT9Wvq0VVbEXARA")
  ], WeaponItem);
  ...
  MainGame = __decorateClass([
    regClass13("F76eGqxSQ_OIlPp4OkKnOA")
  ], MainGame);
      ...
      if (MainGame.instance.gameStep == 1005 /* GameStart */) {
        ...
        if (this.logicTime > 4 * 15) {
          ...
          if (Math.abs(pos.x - this.position.x) > 10 || Math.abs(pos.z - this.position.z) > 13) {
            ...
            this.position = new Vector38(pos.x + point.x, 0, pos.z + point.y);
          }
  ...
  __decorateClass([
    property14({ type: SkinnedMeshSprite3D })
  ...
  ZombieItem = __decorateClass([
    regClass14("g06CffbGQE-koyzPdXCJFw")
  ], ZombieItem);
  ...
  var EnemyMgr = class {
    ...
    createZombie() {
      var _a;
      let zombie;
      zombie = Pool6.getItem("ZOMBIE" /* ZOMBIE */);
      if (!zombie) {
      ...
      zombieItem.position = new Vector39(pos.x + point.x, pos.y, pos.z + point.y);
    ...
    explode(pos, range, damage) {
      for (let i = 0; i < this.zombieList.length; i++) {
        ...
        if (zombieItem && zombieItem.health > 0) {
          let dis = Vector39.distance(pos, zombieItem.position);
          if (range > dis) {
  ...
  PlayerItem = __decorateClass([
    regClass15("d4KV_-VORXaC6vaShc07WA")
  ], PlayerItem);
  ...
  __decorateClass([
    property18({ type: Boolean })
  ], Slider.prototype, "isH", 2);
  __decorateClass([
    property18({ type: Image2 })
  ...
  Slider = __decorateClass([
    regClass18("NbN7uLTyQ2CAMEK2wG7gOA")
  ], Slider);
  ...
  __decorateClass([
    property19({ type: Image3 })
  ], Toggle.prototype, "imgItem", 2);
  Toggle = __decorateClass([
    regClass19("D1okoC-DQhmRZZkZUIKqSg")
  ], Toggle);
  ...
  CompleteView = __decorateClass([
    regClass20("9fN271h0TIqaKICIl2vUaA")
  ], CompleteView);
  ...
  LevelUpView = __decorateClass([
    regClass24("91dzIZCJTXa6O6-ciowK_g")
  ], LevelUpView);
  ...
  __decorateClass([
    property28({ type: Text3 })
  ], MainView.prototype, "txtGold", 2);
  __decorateClass([
    property28({ type: Image11 })
  ...
  __decorateClass([
    property28({ type: Box2 })
  ], MainView.prototype, "Main", 2);
  MainView = __decorateClass([
    regClass28("En-UMdltSRy3giVJqcONew")
  ], MainView);
  ...
  MyInfoView = __decorateClass([
    regClass29("3RbYv1OzQcyBwUTzmv7Ajg")
  ], MyInfoView);
  ...
  PauseView = __decorateClass([
    regClass30("NSwB9cYaQ4e9O2P0EqwSxw")
  ], PauseView);
  ...
  SignInView = __decorateClass([
    regClass37("ZY_MUYEJQqajcg1uNvgBzA")
  ], SignInView);
  ...
  __decorateClass([
    property39({ type: Text5 })
  ], TipsView.prototype, "txtMsg", 2);
  TipsView = __decorateClass([
    regClass39("obEeMzMYT36vHSu_X6EzMw")
  ], TipsView);
})();
