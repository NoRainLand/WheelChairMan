(function (exports, Laya) {
    ...
    class AutoBitmap extends Laya.Graphics {
        ...
        changeSource() {
            ...
            if (!sizeGrid || (sw === width && sh === height))
                cmd = Laya.DrawTextureCmd.create(source, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, width, height, null, 1, null, null, this.uv);
            else
                cmd = Laya.Draw9GridTextureCmd.create(source, 0, 0, width, height, sizeGrid);
    ...
    class Button extends UIComponent {
        ...
        set skin(value) {
            ...
            if (value) {
                let url = this._skinBaseUrl ? Laya.URL.formatURL(value, this._skinBaseUrl) : value;
                this._skins.push(value);
                if (!Laya.Loader.getRes(url))
                    Laya.ILaya.loader.load(url, Laya.Handler.create(this, this._skinLoaded), null, Laya.Loader.IMAGE);
                else
                    this._skinLoaded();
            }
            else
        ...
        set skins(value) {
            ...
            if (this._skins.length > 0) {
                ...
                for (let skin of this._skins) {
                    let url = this._skinBaseUrl ? Laya.URL.formatURL(skin, this._skinBaseUrl) : skin;
                ...
                if (!toLoad)
                    ...
                    Laya.ILaya.loader.load(toLoad, Laya.Loader.IMAGE).then(() => this._skinLoaded());
            }
            else
                this._skinLoaded();
        }
        ...
        changeClips() {
            ...
            if (this._skins.length == 1) {
                let img = Laya.Loader.getRes(this._skins[0]);
                if (!img) {
                ...
                this._sources.length = 0;
                for (let skin of this._skins) {
                    let img = Laya.Loader.getRes(skin);
                    if (img) {
        ...
        set skin(value) {
            ...
            if (value) {
                ...
                if (source) {
                    ...
                    Laya.ILaya.loader.load(url, Laya.Handler.create(this, this.setSource, [this._skin]), null, Laya.Loader.IMAGE, 1, true, this._group);
                }
            }
            else {
                this.source = null;
            ...
            if (this._skin != value) {
                ...
                if (this._skin) {
                    ...
                    Laya.AssetDb.inst.resolveURL(url, url => {
                        Laya.ILaya.loader.load([url, url.replace(".png", "$bar.png")], Laya.Handler.create(this, this._skinLoaded, [url]), null, Laya.Loader.IMAGE);
                    });
                }
                else {
                    this._bg.skin = null;
        ...
        set skin(value) {
            ...
            if (this._skin != value) {
                ...
                if (this._skin) {
                    let url = this._skinBaseUrl ? Laya.URL.formatURL(this._skin, this._skinBaseUrl) : this._skin;
                    Laya.AssetDb.inst.resolveURL(url, url => {
                        Laya.ILaya.loader.load([url,
                            url.replace(".png", "$up.png"),
                            url.replace(".png", "$down.png"),
                            url.replace(".png", "$bar.png")], Laya.Handler.create(this, this._skinLoaded, [url]), null, Laya.Loader.IMAGE);
                    });
                }
                else {
        ...
        set skin(value) {
            if (this._skin != value) {
                ...
                if (this._skin) {
                    let url = this._skinBaseUrl ? Laya.URL.formatURL(this._skin, this._skinBaseUrl) : this._skin;
                    Laya.AssetDb.inst.resolveURL(url, url => {
                        Laya.ILaya.loader.load([url.replace(".png", "$bar.png")], Laya.Handler.create(this, this._skinLoaded, [url]), null, Laya.Loader.IMAGE);
                    });
                }
                else {
                    this._bg.skin = null;
    ...
    class WXOpenDataViewer extends UIComponent {
        constructor() {
            ...
            tex.bitmap = new Laya.Texture2D(this._width, this._height, Laya.TextureFormat.R8G8B8A8, true, false, false);
            this.texture = tex;
        }
        onEnable() {
            this.postMsg({ type: "display", rate: Laya.ILaya.stage.frameRate });
            if (window.wx && window.sharedCanvas)
                Laya.ILaya.timer.frameLoop(1, this, this._onLoop);
        }
        onDisable() {
        ...
        _onLoop() {
            ...
            this.texture.bitmap.setImageData(_canvas, true, false);
        }
        set width(value) {
            super.width = value;
